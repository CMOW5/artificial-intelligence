    ...
    while True:    
        ...
        if not node[0] in closed:
            ...
            for child_node in problem.getSuccessors(node[0]): 
                ...
                search_node.push(newNodePath,child_node[2])           
    ...
    while True:    
        ...
        if not node[0] in closed:
            ...
            for child_node in problem.getSuccessors(node[0]): 
                ...
                nextPosition = child_node[0]   
                prevCost = node[2]
                childNodeCost = child_node[2]
                
                h = manhattanDistance(nextPosition,goalPosition)
                ...
                search_node.push(newNodePath,f)           
